...
export default class Chat extends Component {
  constructor(props) {
    ...
    this.waitForSocketConnection(() => {
      ...
      WebSocketInstance.fetchMessages(this.props.currentUser, this.props.currentlistener);
    });
  }
  ...
  addMessage(message) {
    if((message.author === this.props.currentUser) && (message.listener === this.props.currentlistener))
      this.setState({ messages: [...this.state.messages, message]});
    else if((message.author === this.props.currentlistener) && (message.listener === this.props.currentUser))
      this.setState({ messages: [...this.state.messages, message]});
    else
      console.log("sajal is great")    
  }
  ...
  render() {
    ...
    const currentUser = this.props.currentUser;
    const currentlistener = this.props.currentlistener
    return (
      <div className='chat'>
