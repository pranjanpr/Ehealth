...
urlpatterns = [
    ...
    path('upload/<str:email_user>/<str:title_file>', views.uploads.as_view()),
    path('upload/', views.uploads.as_view()),
    path('get_records/<str:email_id>', views.get_med_records.as_view()),
